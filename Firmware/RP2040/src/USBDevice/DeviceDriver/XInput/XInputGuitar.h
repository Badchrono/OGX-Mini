#ifndef _XINPUT_GUITAR_DEVICE_H_
#define _XINPUT_GUITAR_DEVICE_H_

#include <cstdint>

#include "Descriptors/XInputGuitar.h"
#include "USBDevice/DeviceDriver/DeviceDriver.h"


class XInputGuitarDevice : public DeviceDriver {
public:
...
private:
  XInputGuitar::InReport in_report_;
  XInputGuitar::OutReport out_report_;
};

#endif // _XINPUT_GUITAR_DEVICE_H_
