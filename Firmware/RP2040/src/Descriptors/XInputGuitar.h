#ifndef _XINPUT_GUITAR_DESCRIPTORS_H_
#define _XINPUT_GUITAR_DESCRIPTORS_H_

#include <cstdint>
#include <cstring>

namespace XInputGuitar {
static constexpr size_t ENDPOINT_IN_SIZE = 20;
static constexpr size_t ENDPOINT_OUT_SIZE = 32;

// Guitar Hero 3 controller mapping (works with gamepad mode)
// Frets mapped to triggers/bumpers as GH3 expects:
// Green = LT, Red = LB, Yellow = RB, Blue = RT, Orange = A
...
static const uint8_t STRING_PRODUCT[] = "Xbox 360 Controller (Guitar Mode)";
...
// Device descriptor - Microsoft VID/PID (works on Windows without extra
// drivers)
...
// Configuration descriptor - standard XInput
...
#endif // _XINPUT_GUITAR_DESCRIPTORS_H_
